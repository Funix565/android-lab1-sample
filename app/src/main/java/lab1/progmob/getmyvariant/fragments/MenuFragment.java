...
public class MenuFragment extends BaseFragment {
    ...
    private void updateView() {
        getVariantButton.setEnabled(student != null && student.isValid());
    }

    private ResponseListener<Student> listener = student -> { this.student = student; };
}
